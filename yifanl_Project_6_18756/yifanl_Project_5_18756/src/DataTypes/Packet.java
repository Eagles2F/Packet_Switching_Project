...
public class Packet {
	 ...
	 * @since 1.0
	 */
	public Packet(int source, int dest, String label){
		try{
			this.source = source;
			this.dest = dest;
	...
	public void setOpticalLabel(String opticalLabel) {
		this.opticalLabel = opticalLabel;
	}
